...
// Helper to download image - No longer needed if Genius is removed, but was part of the sync,
// if there was any other image fetching for tracks, we'd keep it.
// Given its location and usage pattern, it's specific to artist images from Genius.
// Since it's only used for Genius, it can also be removed.
